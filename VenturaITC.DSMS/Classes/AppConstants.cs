...
namespace VenturaITC.DSMS.Classes
{
    public class AppConstants
    {
        ...
        public struct ErrorMessage
        {
            ...
            public const string ERROR_INVALID_PASSWORD = "Senha inválida! Deverá conter pelo menos uma letra maíuscula, uma minúscula, um dígito e com tamanho entre 8 e 15 caracteres.";
            public const string ERROR_PASSWORD_DONT_MATCH = "A senha de confirmação difere da senha inserida.";
            public const string ERROR_NEW_PASSWORD_EQUAL_TO_CURRENT = "A nova password não pode ser igua à actual.";
            public const string ERROR_INVALID_FULLNAME = "Nome inválido.";
            public const string ERROR_INVALID_CELL_PHONE_NUMBER = "Nº de celular inválido! Ex.de formato válido: 8212345670.";
